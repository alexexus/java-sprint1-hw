...
public class Main {
    ...
    private static final int SAVING_STEPS_PER_DAY = 1;
    private static final int STATISTICS_CALCULATION = 2;
    private static final int SETTING_STEP_GOAL = 3;
    private static final int EXIT_FROM_PROGRAM = 4;
    private static final int LAST_NUMBER_OF_MONTHS = 11;
    private static final int LAST_NUMBER_OF_DAYS = 29;
